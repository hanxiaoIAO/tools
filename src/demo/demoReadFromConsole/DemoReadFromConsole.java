package demo.demoReadFromConsole;
...
public class DemoReadFromConsole {
	...
	/**
	 * Scanner取得的输入以space, tab, enter 键为结束符， 使用BufferedReader的readLine( )方法
	...
	/**
	 * 使用标准输入串System.in System.in.read()一次只读入一个字节数据，而我们通常要取得一个字符串或一组数字
	 * System.in.read()返回一个整数 必须初始化
	 */
