 ...
 * @author Gaowen
 */
public class DemoPrint extends JPanel implements ActionListener, Printable {
	...
	private static void createAndShowGUI() {
		...
		frame.setContentPane(new DemoPrint());
		frame.pack();
	...
	private class Header extends Component {
		...
		public void paint(Graphics g) {
			if (paintable) {
				...
				g.drawString(
						String.valueOf(previewArea.getPageIndex() + 1) + "/" + String.valueOf(pageBreaks.length + 1)
	...
	private class PreviewArea extends Component {
		...
		public void paint(Graphics g) {
			...
			g2.setStroke(
					new BasicStroke(1f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10f, new float[] { 5, 5 }, 0f));
			g2.drawRect(ix, iy, iw, ih);
			try {
				DemoPrint.this.print(g2, pageFormat, pageIndex);
