...
public class DownYigo {
	...
	private static String[] fileNames = {"map-dev-src.jar","map-dev.jar","map-reportdesign.jar","map-start.jar","yigo-web2.jar","yigoDesigner.jar"};
